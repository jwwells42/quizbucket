...
- **Memorize** — Two modes under one roof:
  - *Texts*: Memorize speeches and poems across 5 levels: full text, first-letter hints, blanks, mostly blank, then recite from memory. Peek-to-reveal and word-by-word feedback.
  - *Sequences*: Learn ordered lists (presidents, monarchs, elements, etc.) through 5 drill types: chunked build-up, fill the gap, next/before, position quiz, and full recitation.
  - Add your own custom texts and sequences.
